...
\begin{enumerate}
      ...
      \item What are the limits of the agents' architectures, the environment, and input representations on learning successfully grounding referring expressions through language games?
