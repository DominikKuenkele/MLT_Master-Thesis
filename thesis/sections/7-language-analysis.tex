...
This is considered as evidence that these features are expressed in the underlying hidden representations of the main model.
...
Tables \ref{tab:probing:discriminator:dale-2} to \ref{tab:probing:attention-predictor:colour} will show the normalized losses $L_{norm}$ of the probing for the different tasks on all three datasets.
