...
This shows that again that the bias in the dataset is enough to ground referring expressions in a spatial context.
...
Additionally, the results suggest difference of difficulties between the attributes.
...
Future work could focus on the reasons for this.
...
This could give insights in if one agent has a bigger influence on the structure of referring expressions.
