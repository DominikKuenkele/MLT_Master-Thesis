...
\begin{figure}[ht!]
        ...
        \caption{Learning curves of all attention reference resolver games on each dataset.The colors correspond to different vocabulary sizes $|V|$. The baseline is marked in black.}
...
These are predictions by the agents that are wrong even thoug a language emerged successfully.
